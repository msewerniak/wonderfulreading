...
public class BooksDataSource {
    ...
    public static List<Book> books() {
        ...
        Unit unitBook1 = new Unit(List.of(new WordLesson(List.of(new Word("Adaś"), new Word("mama"), new Word("Mruczek"))),
        ...
        Book book1 = new Book(1L, "Book 1", 3, unitBook1,
                List.of(new Sentence("To jest Adaś"), new Sentence("To jest Ola"), new Sentence("To jest mama"),
                        new Sentence("To jest tata"), new Sentence("To jest mruczek")));

        Unit unitBook2 = new Unit(List.of(new WordLesson(List.of(new Word("Mysz"), new Word("serek"), new Word("naleśniki"))),
        ...
        Book book2 = new Book(2L, "Book 2", 3, unitBook2,
                List.of(new Sentence("Mysz je serek"), new Sentence("Pies je kość"), new Sentence("Kot je rybkę"),
                        new Sentence("Ola je naleśniki"), new Sentence("Adaś je smakołyki")));

        Unit unitBook3 = new Unit(List.of(new WordLesson(List.of(new Word("Zosia"), new Word("Franek"), new Word("jedzie"))),
        ...
        Book book3 = new Book(3L, "Book 3", 3, unitBook3,
                List.of(new Sentence("Zosia skacze"), new Sentence("Franek biega"), new Sentence("Ola tańczy"),
                        new Sentence("Bartek jedzie"), new Sentence("Magda śpiewa")));

        Unit unitBook4 = new Unit(List.of(new WordLesson(List.of(new Word("zielona"), new Word("chmura"), new Word("żółta"))),
